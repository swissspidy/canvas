...
export const restyleTasks = [
  defineTask({
    ...
    checks: [
      preservesElements(["panel", "heading", "price", "description", "button", "button_label"], 1),
      usesPalette(["#12121f", "#1e1e33", "#f4f1ea", "#a8a3c0", "#e3655b"], 3),
      minContrast(4.5, 3),
      inRegion(["heading"], { x0: 0.4, y0: 0.24, x1: 0.6, y1: 0.33 }, 1, "Nothing has been moved"),
    ],
    judgeCriteria: [
  ...
  defineTask({
    ...
    checks: [
      preservesElements(["photo", "sheet", "title", "standfirst", "byline"], 1),
      minContrast(4.5, 3),
      ...
      inRegion(["title"], { x0: 0.4, y0: 0.44, x1: 0.6, y1: 0.54 }, 1, "Nothing has been moved"),
    ],
    judgeCriteria: [
